...
void Matrix::normalize() {
	GLfloat n = sqrt(mat[0][0]*mat[0][0] + mat[1][0]*mat[1][0]+mat[2][0]*mat[2][0]);
	mat[0][0] = mat[0][0]/n;
	mat[1][0] = mat[1][0]/n;
	mat[2][0] = mat[2][0]/n;
	...
	n = sqrt(mat[0][2]*mat[0][2] + mat[1][2]*mat[1][2]+mat[2][2]*mat[2][2]);
	mat[0][2] = mat[0][2]/n;
	mat[1][2] = mat[1][2]/n;
	mat[2][2] = mat[2][2]/n;
...
void Matrix::rotateMatrix(GLfloat rx, GLfloat ry, GLfloat rz, GLfloat angle) {
	float radianAngle = angle * 3.1415926/180;
